    ...
    >
      ...
      <Column overflowX='hidden'>
        ...
        <Column flexBasis={[129, 40]}>
          ...
          <Box flexBasis={[12, 16]} />
          <Text width='694px' fontSize='increased' lineHeight='high' display={['none', 'inline-flex']}>
            <FormattedMessage id='FrontendDescriptionCourses'/>
          </Text>
          <Text width='335px' fontSize='regular' lineHeight='largest' display={['inline-flex', 'none']}>
      ...
      >
        ...
        <Box flexBasis={[12, 8]} />
        <Text width={[131, 188]} fontSize={['normal', 'regular']} lineHeight={['semiHigh', 'largest']}>
